...
/******/ 	var hotCurrentHash = "faf2fd3598989722d56b"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
		...
		function App(props) {
			...
			_this.state = { content: props.initialContent, markdown: props.initialMd };
			return _this;
		}
		...
		_createClass(App, [{
			...
			value: function handleChange(event) {
				var md = (0, _marked2.default)(event.target.value);
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: 'container' },
					_react2.default.createElement('div', { className: 'row gap-medium' }),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement('textarea', { cols: '70', rows: '25', className: 'editor', value: this.state.content, onChange: this.handleChange.bind(this) })
						),
						_react2.default.createElement(
							'div',
							{ className: 'col-xs-6 col-sm-6' },
	...
	var initMarkdown = (0, _marked2.default)('# Heading1');
	console.log('initMarkdown: ' + initMarkdown);
	App.propTypes = { initialContent: _react2.default.PropTypes.string };
